...
export class Weapon extends Item {
    ...
    constructor(id:number, name: string, descricao: string, peso: number, valor: number, iniciativa: number, BaAdicional: number, dano: Dano, alcance: Array<number>, tamanho: TamanhoArma, tipo: Array<TipoArma>) {
        super(id, name, descricao, peso, valor);
