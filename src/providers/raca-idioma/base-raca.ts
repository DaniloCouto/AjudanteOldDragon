...
export class BaseRaca {
    ...
    public static get BASE_RACA(): Array<Raca>{
        return [
            ...
            new Raca(3,'Elfo','', 1.60, 45, 0, 0, 9,[
                new HabilidadeRacial(null,'Modificadores','Adicione +2 em Destreza, porem retire -2 em Constituição.'),
                new HabilidadeRacial(null,'Visão na Penumbra','Fornece completa visão na penumbra (Baixa iluminação) até 50 metros.'),
            ...
            new Raca(4,'Halfiling','', 0.8, 25, 0, 0, 6,[
